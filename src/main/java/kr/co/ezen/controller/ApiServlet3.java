...
@WebServlet("/ApiServlet3")
public class ApiServlet3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            String urlString = "https://open.api.nexon.com/maplestorym/v1/character/item-equipment?ocid=" + ocid;
         ...
         // JSON 문자열을 JSON 객체로 변환
            ...
            // JSP로 포워딩
            request.getRequestDispatcher("result3").forward(request, response);
